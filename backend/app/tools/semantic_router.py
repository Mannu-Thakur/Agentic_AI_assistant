...
_SYNONYM_MAP = {
    ...
    "interest": ["calculate", "python_sandbox"],
    "solve": ["calculate", "python_sandbox"],
    "formula": ["calculate", "python_sandbox"],
    "fetch": ["web_fetch", "web_extract"],
    "webpage": ["web_fetch", "web_extract"],
    "url": ["web_fetch", "web_extract"],
    "link": ["web_fetch", "web_extract"],
    "spent": ["add_expense", "get_expenses", "list_expenses"],
    "buy": ["add_expense", "get_expenses"],
    "bought": ["add_expense", "get_expenses"],
    "lunch": ["add_expense", "get_expenses"],
    "dinner": ["add_expense", "get_expenses"],
    "expense": ["add_expense", "get_expenses", "summarize_expenses", "list_expenses", "category_summary"],
    "expenses": ["add_expense", "get_expenses", "summarize_expenses", "list_expenses", "category_summary"],
    "remind": ["create_reminder", "get_reminders"],
    "reminder": ["create_reminder", "get_reminders"],
    "reminders": ["create_reminder", "get_reminders"],
    "alarm": ["create_reminder", "get_reminders"],
