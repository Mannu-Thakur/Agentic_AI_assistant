    ...
    <div className="max-w-4xl mx-auto py-10 px-6 space-y-8 animate-in fade-in duration-300">
      ...
      <div className="glass-card-premium p-6 rounded-3xl border border-white/10 shadow-2xl space-y-5">
        ...
        <textarea
          ...
          className="w-full p-4 rounded-2xl border border-white/10 bg-black/40 text-foreground placeholder:text-muted-foreground/40 text-sm focus:outline-none focus:border-violet-500/60 focus:ring-2 focus:ring-violet-500/20 resize-y leading-relaxed backdrop-blur-sm transition-all"
        />
        ...
        <div className="flex items-center justify-between pt-2">
          <button
            onClick={() => setStep(1)}
            className="flex items-center space-x-2 px-4 py-2.5 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-xs font-semibold transition-all hover:scale-105 active:scale-95"
          >
          ...
          <div className="flex items-center space-x-3">
            <button
              onClick={handleSkip}
              className="px-4 py-2.5 rounded-xl border border-white/10 bg-transparent hover:bg-white/5 text-xs font-medium text-muted-foreground hover:text-foreground transition-all"
            >
